...
import patchProduct from '../../apis/patchProduct'



const ProductDataForm = () => {
  const { onCreateNewProduct ,productList} = useContext(AppData)
  ...
  if (id === undefined){
   ...
   defaultForm={...productList.filter(product=>product._id==id)[0]}
  }
